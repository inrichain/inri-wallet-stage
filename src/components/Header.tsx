    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div
            style={{
              ...
              display: "grid",
              placeItems: "center",
              background: isLight ? "#eff4ff" : "#16213b",
              color: "#3f7cff",
              fontWeight: 900,
              fontSize: 16,
            }}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
          <div style={{ padding: "8px 14px", borderRadius: 999, border: "1px solid rgba(63,124,255,.35)", background: "rgba(63,124,255,.12)", color: "#3f7cff", fontWeight: 800, fontSize: 14 }}>
